...
public class FinalProjectApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Evenements ev1 = new Evenements( null, "nom1", date1, "chez oim",null, "desc1", 12, 100, "bas", m1); //à supprimer créé pour l'évent
		Evenements ev2 = new Evenements( null, "nom2", date1, "chez twa",null,"desc", 2 , 2, "expert", m1); //à supprimer créé pour l'évent
		Evenements ev3 = new Evenements( null, "nom3", date1, "chez",null,"desc", 2 , 2, "pas ouf", m1); //à supprimer créé pour l'évent
		eventRepo.save(ev1);
		eventRepo.save(ev2);
		eventRepo.save(ev3);
