...
public class FinalProjectApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Evenements ev1 = new Evenements( null, "Match de foot ce Week-End", date5, "Stade","Football", "petit match de foot à 11 contre 11, niveau correct sans pretention", 22, 28, "Intermédiaire", m1); //à supprimer créé pour l'évent
		Evenements ev2 = new Evenements( null, "Rencontre autour d'un match de basket", date2, "Gymnase","Basket","Match de basket pour faire des rencontres", 10 , 16, "debutant", m2); //à supprimer créé pour l'évent
		Evenements ev3 = new Evenements( null, "Apres midi jeux de cartes", date3, "chez moi","Tarot","Petite apres-midi detente", 3 , 5, "debutant", m3); //à supprimer créé pour l'évent
		Evenements ev4 = new Evenements( null, "Tryhard FIFA", date4, "A la maison","fifa", "Objectif: s'ameliorer en affrontant des machines", 2, 6, "Expert", m4);
